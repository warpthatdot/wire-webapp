...
describe('z.tracking.EventTrackingRepository', () => {
  ...
  beforeEach(() => {
    return new TestFactory().exposeTrackingActors().then(({repository}) => {
      ...
      trackingRepository._isDomainAllowedForAnalytics = () => true;
    });
  });
  ...
  describe('Initialization', () => {
    it('enables error reporting, user tracking and subscribes to tracking events', () => {
      ...
      spyOn(trackingRepository, '_enableAnalytics').and.callThrough();
      spyOn(trackingRepository, '_subscribeToAnalyticsEvents').and.callThrough();
      ...
      return trackingRepository.init(true).then(() => {
        ...
        expect(trackingRepository._enableAnalytics).toHaveBeenCalled();
        expect(trackingRepository._subscribeToAnalyticsEvents).toHaveBeenCalled();
      });
    });
